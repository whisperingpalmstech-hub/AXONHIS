...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Diagnostic Procedures", href: "/dashboard/diagnostics" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "OP Returns", href: "/dashboard/sales-returns", roles: ["pharmacist", "admin"] },
...
const LABEL_I18N_MAP: Record<string, string> = {
  ...
  "Laboratory": "nav.laboratory", "Radiology": "nav.radiology", "Diagnostic Procedures": "nav.diagnosticProcedures", "Blood Bank": "nav.bloodBank",
