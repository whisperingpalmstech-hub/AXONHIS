      ...
      <div ref={searchRef} className="topnav-search-wrapper">
        <div className="topnav-search-container">
          ...
          <input
            ...
            type="text"
            placeholder="Search patients by UHID, name, mobile..."
          ...
          <div className="topnav-search-results" id="search-results">
            {searchResults.length === 0 && !isSearching ? (
              <div className="px-4 py-8 text-center">
                ...
                <p className="text-sm text-slate-400">No patients found for &quot;{searchQuery}&quot;</p>
                <p className="text-xs text-slate-400 mt-1">Try searching by UHID, name, or phone number</p>
              </div>
            ) : (
              <div>
